...
def add_campaign_targeting_criteria(client, customer_id, campaign_id, keyword_text, location_id):
...
'''
    ...
    parser.add_argument(
        "-k", "--keyword_text", type=str, required=True,
        help="The keyword text to be added to the campaign.", )
    parser.add_argument(
        "-l", "--location_id", type=str, required=False, default="21167",  # New York
        help=(
